...
! function(n) { 
    ...
    n("#experience-timeline").each(function() { 
        ...
        $this.find('.vtimeline-point').each(function() {
            if (icon == 0) {
                n(this).prepend('<div class="vtimeline-pic"><img src = "/images/RiseLab.png"></div>'); 
                icon = icon + 1;
            } else if (icon == 1) {
                n(this).prepend('<div class="vtimeline-pic"><img src = "/images/Bespoke.png"></div>'); 
                icon = icon + 1;
            } else if (icon == 2) {
                n(this).prepend('<div class="vtimeline-pic"><img src = "/images/SwarmLab.png"></div>'); 
               icon = icon + 1;
            } else if (icon == 3) {
                n(this).prepend('<div class="vtimeline-pic"><img src = "/images/Intensivate.png"></div>'); 
                icon = icon + 1;
            } else if (icon == 4) {
                n(this).prepend('<div class="vtimeline-pic"><img src = "/images/Codeology.png"></div>'); 
                icon = icon + 1;
            }
        });
    	//$this.find(".vtimeline-point").each(function() { 

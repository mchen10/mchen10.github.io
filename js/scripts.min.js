...
! function(n) { 
    ...
    n("#experience-timeline").each(function() { 
        ...
        $this.find('.vtimeline-point').each(function() {
            if (icon == 0) {
                n(this).prepend('<a href = "https://rise.cs.berkeley.edu/projects/clipper/"><div class="vtimeline-pic"><img class = "vtimeline-img-1" src = "/images/RiseLab.jpg"></div></a>'); 
                icon = icon + 1;
            } else if (icon == 1) {
                n(this).prepend('<a href = "https://www.be-spoke.io/"><div class="vtimeline-pic"><img class = "vtimeline-img-2" src = "/images/Bespoke.png"></div></a>'); 
                icon = icon + 1;
            } else if (icon == 2) {
                n(this).prepend('<a href = "https://swarmlab.berkeley.edu/home"><div class="vtimeline-pic"><img class = "vtimeline-img-3" src = "/images/SwarmLab.png"></div></a>'); 
               icon = icon + 1;
            } else if (icon == 3) {
                n(this).prepend('<a href = "http://intensivate.com/"><div class="vtimeline-pic"><img class = "vtimeline-img-4" src = "/images/Intensivate.png"></div></a>'); 
                icon = icon + 1;
            } else if (icon == 4) {
                n(this).prepend('<a href = "https://www.codeology.club/"><div class="vtimeline-pic"><img class = "vtimeline-img-5" src = "/images/Codeology.png"></div></a>'); 
                icon = icon + 1;
            }
        });
    	//$this.find(".vtimeline-point").each(function() { 
